...
export const products: Product[] = [
  ...
  {
    id: "teckel-choco-dapple",
    name: "Teckel Dachshund Chocolate Dapple",
    breed: "Teckel / Dachshund",
    size: "pequeno",
    price: 3300000,
    status: "disponible",
    ...
    featured: true,
    description:
      "Teckel miniatura Chocolate Dapple, ojos azules y patrón único. Ejemplar exótico criado con responsabilidad.",
  },
  {
    id: "pomerania",
    name: "Pomerania",
